...
// PREDICT WEATHER IN NEXT 3 DAYS PAGE
		...
		layoutPredictionPane.getChildren().add(predictionPageView);
		layoutPredictionPane.getChildren().add(layoutPrediction);
		layoutPredictionPane.setAlignment(Pos.TOP_CENTER);
